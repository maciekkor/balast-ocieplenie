...
const EN = {
  ...
  'Brakuje jeszcze: {x}':'Still missing: {x}','Dodaj jeszcze: {x}':'Add one more thing: {x}',
  'Pianka albo suchy skafander':'Wetsuit or drysuit','Butla':'Cylinder','Kamizelka albo skrzydło z płytą':'BCD or wing with a backplate',
  'ocieplenie':'exposure suit','butla':'cylinder','kamizelka':'BCD','jest':'added','brakuje':'missing',
